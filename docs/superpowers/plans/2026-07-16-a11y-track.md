...
**Goal:** Thêm Type test thứ 2 — Accessibility (WCAG, black-box) — cho threease_qa: quét các màn đang test bằng axe-core, xuất report riêng + đẩy lỗi nặng vào sổ bug.
...
- Tất cả path lệnh chạy từ **repo root** `threease_qa/`. Script dir viết tắt:
